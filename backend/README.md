...
## Project Structure
    ...
    ├── module_options_test_29674  # Django project configurations
...
1. Clone this repo and `cd module_options_test_29674`
...
2. Clone this repo and `cd module_options_test_29674`
